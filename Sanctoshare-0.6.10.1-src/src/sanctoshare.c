/* 
    ...
    Visit me online at: http://haxlab.org

    THANKS:

    Love to my bro Ed Poole and Mr Graham Anderson and Mike Parfitt.
...
#define PROGRAM_VERSION "0.6.10.1 (SSL) \"Saint John Chrysostom\""

#define _DEFAULT_SOURCE 0xffff
#include <stdio.h>
#include <stdlib.h>
#include <stdarg.h>
#include <string.h>
...
{
	//Version();
	Error("Did you read the manual???", DROP_CONFIG_FILE);
}
